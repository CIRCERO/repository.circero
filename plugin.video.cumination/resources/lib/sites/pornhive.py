...
site = AdultSite('pornhive', '[COLOR yellow]PornHive[/COLOR]', 'http://www.pornhive.tv/', 'ph.gif', 'pornhive')
...
def PHMain():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'en/categories', 'PHCat', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'en/search?keyword=', 'PHSearch', site.img_search)
