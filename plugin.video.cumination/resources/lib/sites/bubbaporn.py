...
site = AdultSite('bubbaporn', '[COLOR yellow]BubbaPorn[/COLOR]', 'https://www.bubbaporn.com/', 'bubba.gif', 'bubbaporn')


@site.register(default_mode=True)
def TPMain():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'channels/', 'TPCat', site.img_cat)
    site.add_dir('[COLOR yellow]Pornstars[/COLOR]', site.url + 'pornstars/', 'TPPornstars', '', '')
    site.add_dir('[COLOR yellow]Top Rated[/COLOR]', site.url + 'top-rated/a/', 'TPList', '', '')
    site.add_dir('[COLOR yellow]Most Viewed[/COLOR]', site.url + 'most-viewed/a/', 'TPList', '', '')
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'search/?q=', 'TPSearch', site.img_search)
    TPList(site.url)
    utils.eod()
