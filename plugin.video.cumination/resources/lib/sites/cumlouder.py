...
site = AdultSite('cumlouder', '[COLOR yellow]Cum Louder[/COLOR]', 'https://www.cumlouder.com/', 'cumlouder.jpg', 'cumlouder')
...
def Main():
    ...
    site.add_dir('[COLOR yellow]Series[/COLOR]', site.url + 'series/', 'Series', site.img_cat)
    site.add_dir('[COLOR yellow]Pornstars[/COLOR]', site.url + 'girls/', 'Girls', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'search/?q=', 'Search', site.img_search)
    List(site.url + 'porn/')
    utils.eod()
