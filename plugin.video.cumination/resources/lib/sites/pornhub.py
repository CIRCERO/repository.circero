...
site = AdultSite('pornhub', '[COLOR yellow]PornHub[/COLOR]', 'https://www.pornhub.com/', 'pornhub.gif', 'pornhub')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'video/search?o=mr&search=', 'Search', site.img_search)
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'categories?o=al', 'Categories', site.img_cat)
