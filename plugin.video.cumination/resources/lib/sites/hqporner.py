...
site = AdultSite('hqporner', '[COLOR yellow]HQPorner[/COLOR]', 'https://hqporner.com', 'hqporner.gif', 'hqporner')


@site.register(default_mode=True)
def HQMAIN():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + '/porn-categories.php', 'HQCAT', site.img_cat)
    site.add_dir('[COLOR yellow]Studios[/COLOR]', site.url + '/porn-studios.php', 'HQCAT', '', '')
    site.add_dir('[COLOR yellow]Girls[/COLOR]', site.url + '/porn-actress.php', 'HQCAT', '', '')
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + '/?s=', 'HQSEARCH', site.img_search)
