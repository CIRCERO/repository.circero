...
site = AdultSite('xvideospanish', '[COLOR yellow]XvideoSpanish[/COLOR]', 'https://www.xn--xvideos-espaol-1nb.com/', 'xvideospanish.gif', 'xvideospanish')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Tags[/COLOR]', site.url + 'tags/', 'Tags', '', '')
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'videos-pornos-por-productora-gratis/', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Actors[/COLOR]', site.url + 'actors/', 'Categories', '', '')
