...
site = AdultSite('xtheatre', '[COLOR yellow]Xtheatre[/COLOR]', 'https://pornxtheatre.com/', 'https://pornxtheatre.com/wp-content/uploads/2020/06/ggf.png', 'xtheatre')
...
def XTMain():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'categories/', 'XTCat', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + '?s=', 'XTSearch', site.img_search)
