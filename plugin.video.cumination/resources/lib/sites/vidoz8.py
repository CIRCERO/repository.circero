...
site = AdultSite('vidz7', '[COLOR yellow]Vidoz8[/COLOR]', 'http://vidoz8.com/', 'vidoz8.gif', 'vidoz8')
...
def v7_main():
    site.add_dir('[COLOR yellow]Studios[/COLOR]', site.url + 'channels/?sort=name', 'v7_cat', '', '')
    site.add_dir('[COLOR yellow]Tags[/COLOR]', site.url + 'tags/', 'v7_tag', '', '')
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + '?s=', 'v7_search', site.img_search)
