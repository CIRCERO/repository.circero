...
site = AdultSite('justporn', '[COLOR yellow]JustPorn[/COLOR]', 'http://justporn.to/', 'justporn.gif', 'justporn')
...
def Main():
    ...
    site.add_dir('[COLOR yellow]HD-Filme[/COLOR]', site.url + 'category/hd-filme/', 'List', '', '')
    site.add_dir('[COLOR yellow]Deutsche Filme[/COLOR]', site.url + 'category/deutsche-filme/', 'List', '', '')
