...
site = AdultSite('daftsex', '[COLOR yellow]DaftSex[/COLOR]', 'https://daftsex.com/', 'daftsex.gif', 'daftsex')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', '{0}categories'.format(site.url), 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', '{0}video/'.format(site.url), 'Search', site.img_search)
