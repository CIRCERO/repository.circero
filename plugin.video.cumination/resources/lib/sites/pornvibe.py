...
site = AdultSite('pornvibe', '[COLOR yellow]Pornvibe[/COLOR]', 'https://pornvibe.org/', 'pornvibe.gif',
                 'pornvibe')


@site.register(default_mode=True)
def pornvibe_main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'categories/', 'pornvibe_cat', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + '?s=', 'pornvibe_search', site.img_search)
