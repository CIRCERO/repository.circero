...
site = AdultSite('speedporn', '[COLOR yellow]SpeedPorn[/COLOR]', 'https://speedporn.net/', 'speedporn.gif', 'speedporn')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', '{}categories/'.format(site.url), 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Porn-genres[/COLOR]', '{}porn-genres/'.format(site.url), 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Tags[/COLOR]', '{}channels/tags/'.format(site.url), 'Tags', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', '{}?s='.format(site.url), 'Search', site.img_search)
    List(site.url)
    utils.eod()
