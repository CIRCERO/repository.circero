...
site = AdultSite('jav789', '[COLOR yellow]JAV 789[/COLOR]', 'https://jav789.com/', 'jav789.gif', 'jav789')
site1 = AdultSite('javbuz', '[COLOR yellow]JAV Buz[/COLOR]', 'https://javbuz.com/', 'javbuz.gif', 'javbuz')
site2 = AdultSite('javhihi', '[COLOR yellow]JAV HiHi[/COLOR]', 'https://javkiki.com/', 'javhihi.gif', 'javhihi')
site3 = AdultSite('letfap', '[COLOR yellow]Let FAP[/COLOR]', 'https://letfap.com/', 'letfap.gif', 'letfap')
...
def Main(url):
    ...
    site.add_dir('[COLOR yellow]Categories[/COLOR]', siteurl + 'movie', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Pornstars[/COLOR]', siteurl + 'pornstar', 'Pornstars', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', siteurl + 'movie?q=', 'Search', site.img_search)
    List(siteurl + 'movie')
    utils.eod()
