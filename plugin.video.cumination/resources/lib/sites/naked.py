...
site = AdultSite('naked', '[COLOR yellow]Naked[/COLOR]', 'https://www.naked.com/', 'naked.gif', 'naked', True)
...
def Main():
    ...
    if female:
        site.add_dir('[COLOR yellow]Females[/COLOR]', site.url + 'live/girls/', 'List', '', 1)
    if male:
        site.add_dir('[COLOR yellow]Males[/COLOR]', site.url + 'live/guys/', 'List', '', 1)
    if trans:
        site.add_dir('[COLOR yellow]Transsexual[/COLOR]', site.url + 'live/trans/', 'List', '', 1)
    utils.eod()
