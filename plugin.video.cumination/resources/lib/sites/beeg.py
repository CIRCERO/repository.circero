...
addon = utils.addon
site = AdultSite("beeg", "[COLOR yellow]Beeg[/COLOR]", "https://beeg.com/api/v6/", "bg.gif", "beeg")
...
def BGMain():
    ...
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + bgversion + '/tags', 'BGCat', site.img_cat)
    site.add_dir('[COLOR yellow]Channels[/COLOR]', site.url + bgversion + '/channels', 'BGChnl', site.img_cat)
    site.add_dir('[COLOR yellow]Porn Stars[/COLOR]', site.url + bgversion + '/people', 'BGPpl', site.img_cat)
    # site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + bgversion + '/index/main/0/pc?query=', 'BGSearch', site.img_search)
...
def BGCat(url):
    ...
    for cat in cats:
        ...
        name = title + ' [COLOR yellow](%s videos)[/COLOR]' % cat['videos']
...
def BGChnl(url):
    ...
    for cat in cats:
        ...
        name = title + ' [COLOR yellow]({0} videos)[/COLOR]'.format(cat['videos'])
        if cat['image']:
