...
site = AdultSite('xvideos', '[COLOR yellow]xVideos[/COLOR]', 'https://www.xvideos.com/', 'xvideos.gif', 'xvideos')
...
def Main():
    ...
    site.add_dir('[COLOR yellow]Country: [/COLOR] [COLOR orange]{}[/COLOR]'.format(country), site.url, 'Country', site.img_cat)
    site.add_dir('[COLOR yellow]Category: [/COLOR] [COLOR orange]{}[/COLOR]'.format(category), site.url, 'Category', site.img_cat)
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + categories[category], 'Categories', site.img_cat)
    cat = 'trans/' if category == 'Trans' else categories[category]
    country = country.lower().replace(' ', '_').replace(',', '_') + '/'
    site.add_dir('[COLOR yellow]Pornstars[/COLOR]', site.url + 'pornstars-index/{}{}from/worldwide'.format(cat, country), 'Pornstars', site.img_cat)
    site.add_dir('[COLOR yellow]Tags[/COLOR]', site.url + 'tags', 'Tags', site.img_cat)
    cat = 'straight' if category == 'Straight' else categories[category][:-1]
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + '?typef={}&k='.format(cat), 'Search', site.img_search)
