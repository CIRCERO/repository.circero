...
site = AdultSite('eporner', '[COLOR yellow]Eporner[/COLOR]', 'https://www.eporner.com/', 'eporner.gif', 'eporner')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'cats/', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Pornstars[/COLOR]', site.url + 'pornstar-list/', 'Pornstars', site.img_cat)
    site.add_dir('[COLOR yellow]Lists[/COLOR]', site.url, 'Lists', site.img_cat)
