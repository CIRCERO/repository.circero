...
site = AdultSite('mrsexe', '[COLOR yellow]Mr Sexe[/COLOR]', 'https://www.mrsexe.com/', 'mrsexe.gif', 'mrsexe')
...
def Main():
    site.add_dir('[COLOR yellow]Classiques[/COLOR]', site.url + 'classiques/', 'List', '', '')
    ...
    site.add_dir('[COLOR yellow]Stars[/COLOR]', site.url + 'filles/', 'Stars', '', '')
    List(site.url)
    utils.eod()
