...
site = AdultSite('netflixporno', '[COLOR yellow]NetflixPorno[/COLOR]', 'https://netflixporno.net/', 'netflixporno.gif', 'netflixporno')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Search[/COLOR]', 'https://netflixporno.net/search/', 'Search', site.img_search)
    site.add_dir('[COLOR yellow]New Release[/COLOR]', 'https://netflixporno.net/genre/new-release/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]XXX Scenes[/COLOR]', 'https://netflixporno.net/genre/clips-scenes/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Parody Movies[/COLOR]', 'https://netflixporno.net/genre/parodies/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Categories[/COLOR]', 'https://netflixporno.net/', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Studios[/COLOR]', 'https://netflixporno.net/', 'Studios', site.img_cat)
