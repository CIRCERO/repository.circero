...
site = AdultSite("anybunny", "[COLOR yellow]Anybunny[/COLOR]", "http://anybunny.com/", "anybunny.gif", "anybunny")


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Top videos[/COLOR]', site.url + 'top/', 'List', '', '')
    site.add_dir('[COLOR yellow]Categories - images[/COLOR]', site.url, 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Categories - all[/COLOR]', site.url, 'Categories2', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'new/', 'Search', site.img_search)
