...
site = AdultSite('streamate', '[COLOR yellow]streamate.com[/COLOR]', 'http://www.streamate.com', 'streamate.gif', 'streamate', True)


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR red]Refresh streamate.com images[/COLOR]', '', 'clean_database', '', Folder=False)
    site.add_dir('[COLOR yellow]Search + Fav add[/COLOR]', 'https://www.streamate.com/cam/', 'Search', site.img_search)
