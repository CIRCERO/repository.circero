...
site = AdultSite('streamxxx', '[COLOR yellow]StreamXXX[/COLOR]', 'https://streamxxx.tv/', 'streamxxx.gif', 'streamxxx')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url, 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Tags[/COLOR]', site.url, 'Tags', '', '')
    site.add_dir('[COLOR yellow]Movies[/COLOR]', site.url + 'category/movies-xxx/', 'MainMovies', '', '')
    site.add_dir('[COLOR yellow]International Movies[/COLOR]', site.url + 'category/movies-xxx/international-movies/', 'MainInternationalMovies', '', '')
    site.add_dir('[COLOR yellow]Search Overall[/COLOR]', site.url + '?s=', 'Search', site.img_search)
    site.add_dir('[COLOR yellow]Search Scenes[/COLOR]', site.url + '?cat=5562&s=', 'Search', site.img_search)
