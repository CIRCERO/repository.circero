...
site = AdultSite('datoporn', '[COLOR yellow]DatoPorn[/COLOR]', 'https://dato.porn/', 'datoporn.gif', 'datoporn')


@site.register(default_mode=True)
def datoporn_main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', '{0}categories/'.format(site.url), 'datoporn_cat', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', 'search', 'datoporn_search', site.img_search)
