...
site = AdultSite('porndig', '[COLOR yellow]Porndig[/COLOR] [COLOR lime]Professional[/COLOR]', 'https://www.porndig.com/',
                 'porndig.gif', 'porndig')
site2 = AdultSite('porndig2', '[COLOR yellow]Porndig[/COLOR] [COLOR lime]Amateurs[/COLOR]', 'http://www.porndig.com/',
                  'porndig.gif', 'porndig')
...
def Main(name):
    ...
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'videos/', 'Categories', site.img_cat)
    if addon.getSetting("pdsection") == '0':
        site.add_dir('[COLOR yellow]Studios[/COLOR]', site.url + 'studios/load_more_studios', 'Studios', '', 0)
        site.add_dir('[COLOR yellow]Pornstars[/COLOR]', site.url + 'pornstars/load_more_pornstars', 'Pornstars', '', 0)
    List(1, 0, 0)
