...
site = AdultSite('vipporns', '[COLOR yellow]VIP Porns[/COLOR]', 'https://www.vipporns.com/', 'vipporns.gif', 'vipporns')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'categories/', 'Cat', site.img_cat)
