...
site = AdultSite('javmoe', '[COLOR yellow]JAV Moe[/COLOR]', 'https://javmama.me/', 'javmoe.gif', 'javmoe')
...
def Main():
    site.add_dir('[COLOR yellow]Genres[/COLOR]', site.url + 'genres/', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Pornstars[/COLOR]', site.url + 'pornstars/', 'Letters', '', '')
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + '?s={}&post_type=post', 'Search', site.img_search)
    List(site.url)
    utils.eod()
