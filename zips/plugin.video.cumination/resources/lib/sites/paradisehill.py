...
site = AdultSite('paradisehill', '[COLOR yellow]ParadiseHill[/COLOR]', "https://en.paradisehill.cc/", "paradisehill.gif",
                 'paradisehill')
...
def Main():
    ...
    site.add_dir('[COLOR yellow]Search[/COLOR]', '{0}search/?pattern='.format(site.url), 'Search', site.img_search)
