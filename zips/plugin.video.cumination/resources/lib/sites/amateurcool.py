...
site = AdultSite("amateurcool", "[COLOR yellow]Amateur Cool[/COLOR]", "https://www.amateurcool.com/", "amateurcool.gif", 'amateurcool')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', '{0}/channels/'.format(site.url), 'Categories', site.img_cat)
