...
site = AdultSite('porn00', '[COLOR yellow]Porn00[/COLOR]', 'https://www.porn00.org', 'p00.gif', 'porn00')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', '{0}/tags/'.format(site.url), 'Cat', site.img_cat)
