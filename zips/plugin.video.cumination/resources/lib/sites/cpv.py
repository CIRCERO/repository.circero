...
site = AdultSite("cpv", "[COLOR yellow]Cartoon Porn Videos[/COLOR]", "https://www.cartoonpornvideos.com/", "cpv.gif", "cpv")


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', '{0}categories/'.format(site.url), 'Cat', site.img_cat)
    site.add_dir('[COLOR yellow]Characters[/COLOR]', '{0}characters/'.format(site.url), 'Char', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', '{0}search/video/'.format(site.url), 'Search', site.img_search)
