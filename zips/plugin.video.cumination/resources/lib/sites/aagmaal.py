...
site = AdultSite('aagmaal', '[COLOR yellow]Aag Maal[/COLOR]', 'https://aagmaal.com/', 'aagmaal.gif', 'aagmaal')
...
def List2(url):
    ...
    if url:
        pgtxt = 'Currently in {0}'.format(re.findall(r'class="pages">([^<]+)', listhtml)[0])
        site.add_dir('[COLOR yellow]Next Page...[/COLOR] {0}'.format(pgtxt), url.group(1), 'List2', site.img_next)
    utils.eod()
