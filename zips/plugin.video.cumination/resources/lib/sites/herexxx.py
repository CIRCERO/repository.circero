...
site = AdultSite('herexxx', '[COLOR yellow]HereXXX[/COLOR]', 'https://herexxx.com/', 'herexxx.gif', 'herexxx')
site1 = AdultSite('asstoo', '[COLOR yellow]Asstoo[/COLOR]', 'https://asstoo.com/', 'asstoo.gif', 'asstoo')
...
def Main(url):
    ...
    site.add_dir('[COLOR yellow]Sort Order: [/COLOR] [COLOR orange]{}[/COLOR]'.format(ordername), siteurl, 'Sortorder', site.img_cat)
    site.add_dir('[COLOR yellow]Categories[/COLOR]', siteurl + 'categories/', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Lists[/COLOR]', siteurl, 'Lists', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', siteurl + 'search/video/?s=', 'Search', site.img_search)
    List(siteurl + 'videos/')
    utils.eod()
