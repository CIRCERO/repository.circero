...
site = AdultSite('pornroom', '[COLOR yellow]Pornroom[/COLOR]', 'https://pornroom.club/', 'pornroom.jpg', 'pornroom')


@site.register(default_mode=True)
def pornroom_main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'categories/', 'pornroom_cat', site.img_cat)
