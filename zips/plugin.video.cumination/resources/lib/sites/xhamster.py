...
site = AdultSite('xhamster', '[COLOR yellow]xHamster[/COLOR]', 'https://xhamster.com/', 'xhamster.png', 'xhamster')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories - Straight[/COLOR]', site.url + 'categories', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Categories - Gay[/COLOR]', site.url + 'gay/categories', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Categories - Shemale[/COLOR]', site.url + 'shemale/categories', 'Categories', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'search.php?q=', 'Search', site.img_search)
    List(site.url)
    utils.eod()
