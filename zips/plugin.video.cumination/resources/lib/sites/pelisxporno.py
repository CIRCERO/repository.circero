...
site = AdultSite('pelisxporno', '[COLOR yellow]PelisxPorno[/COLOR]', "https://www.pelisxporno.net/", "pelisxporno.gif",
                 'pelisxporno')
...
def Main():
    ...
    site.add_dir('[COLOR yellow]Pelicula En Español[/COLOR]', site.url + 'pelicula-xxx-espanol/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Incesto[/COLOR]', site.url + 'incesto-online/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Madres[/COLOR]', site.url + 'tag/madres/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Parodia[/COLOR]', site.url + 'parodia-xxx/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Brazzers En Español[/COLOR]', site.url + 'brazzers-en-espanol-gratis/', 'List', site.img_cat)
    site.add_dir('[COLOR yellow]Videos Españoles[/COLOR]', site.url + 'videos-espanoles/', 'List', site.img_cat)
