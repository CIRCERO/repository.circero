...
site = AdultSite('ipv', '[COLOR yellow]Indian Porn Videos[/COLOR]', 'https://www.indianpornvideos2.com/', 'ipv.gif', 'ipv')
...
def List(url):
    ...
    if url:
        ...
        site.add_dir('[COLOR yellow]Next Page...[/COLOR] {0}'.format(pgtxt), url.group(1), 'List', site.img_next)
    utils.eod()
