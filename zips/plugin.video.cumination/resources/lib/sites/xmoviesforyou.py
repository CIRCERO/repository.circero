...
site = AdultSite('xmoviesforyou', '[COLOR yellow]Xmoviesforyou[/COLOR]', 'https://xmoviesforyou.com/', 'https://xmoviesforyou.com/wp-content/uploads/2018/08/logo.png', 'xmoviesforyou')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'wp-json/wp/v2/categories?page=1', 'Categories', site.img_cat)
    # site.add_dir('[COLOR yellow]Tags[/COLOR]', site.url + 'wp-json/wp/v2/tags?page=1', 'Categories', site.img_cat)
...
def Categories(url):
    ...
    for category in jdata:
        name = '{} ([COLOR yellow]{}[/COLOR])'.format(category['name'], category['count'])
