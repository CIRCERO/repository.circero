...
site = AdultSite('xfreehd', '[COLOR yellow]XFreeHD[/COLOR]', 'https://www.xfreehd.com/', 'xfreehd.gif', 'xfreehd')


@site.register(default_mode=True)
def xfreehd_main():
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url + 'categories', 'xfreehd_cat', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', site.url + 'search?search_query=', 'xfreehd_search', site.img_search)
...
def xfreehd_cat(url):
    ...
    for catpage, img, name, videos in match:
        name = utils.cleantext(name.strip()) + " [COLOR yellow]%s Videos[/COLOR]" % videos
