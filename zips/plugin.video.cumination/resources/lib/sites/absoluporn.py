...
site = AdultSite('absoluporn', '[COLOR yellow]AbsoluPorn[/COLOR]', "http://www.absoluporn.com/en", "absoluporn.gif", 'absoluporn')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR yellow]Top Rated[/COLOR]', '{0}/wall-note-1.html'.format(site.url), 'List', '', '')
    site.add_dir('[COLOR yellow]Most Viewed[/COLOR]', '{0}/wall-main-1.html'.format(site.url), 'List', '', '')
    site.add_dir('[COLOR yellow]Longest[/COLOR]', '{0}/wall-time-1.html'.format(site.url), 'List', '', '')
    site.add_dir('[COLOR yellow]Categories[/COLOR]', site.url, 'Cat', site.img_cat)
    site.add_dir('[COLOR yellow]Search[/COLOR]', '{0}/search-'.format(site.url), 'Search', site.img_search)
